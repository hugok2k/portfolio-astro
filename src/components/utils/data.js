export const data = [
  ...
  {
    href: 'https://github.com/hugok2k/PI-Henry-Food',
    title: 'Food API',
    body: 'Proyecto individual en Henry, bootcamp full-stack. Sitio web de recetas utilizando API de tercero.',
    image: 'images/pihenry.jpg',
    tools: 'ReactJS - NodeJS - PostgreSQL - CSS',
    deploy: 'https://pi-henry-food-phi.vercel.app/'
  },
  {
